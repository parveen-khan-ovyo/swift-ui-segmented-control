...
public class HMSegementedControl: NSObject {
    ...
    /// set/update the font name  of the segmentControl  view
    ...
    public func create() -> UIView {
        let segmentControlView = HMSegementedControlView(viewModel: segmentedControlViewModel)
        segmentedOCntrol = segmentControlView
        let customView: UIView = segmentControlView.convertToUIView()
